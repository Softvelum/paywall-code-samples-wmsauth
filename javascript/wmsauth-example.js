/* This server side example includes Date Format library and WMSAuth sample code */
...
http.createServer(function (req, res) {
	  ...
	  var signedurlwithvalidinterval = initial_url + "?wmsAuthSign=" + base64urlsignature;

          res.end(signedurlwithvalidinterval);
}).listen(80, '0.0.0.0');
